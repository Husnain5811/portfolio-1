...
const Contact = () => {
 ...
 <section class="text-gray-600 bg-[#2E0043] body-font relative">
    
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 className="text-2xl w-[150px] p-2 mx-auto rounded-bl-4xl rounded-tr-4xl  text-white block text-center share-tech bg-gradient-to-r from-[#15001F] shadow-[#2e0043] shadow-xl via-[#2e0043] to-[black] ...">Contact us</h1>
